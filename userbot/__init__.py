...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/MAHADEV-X-FORCE/ANGEL-USERBOTS.git")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/d6d167386d2eba4b7dabc.jpg"
...
async def check_alive():
    await bot.send_message(BOTLOG_CHATID, "**⚡Snoopy⚡** ```Has Been Active!```")
    return
...
async def update_restart_msg(chat_id, msg_id):
    ...
    message = (
        f"**Userbot Snoopy Is Up Running!**\n\n"
